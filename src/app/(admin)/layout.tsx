  ...
  return (
    <div className="flex min-h-screen bg-neutral-50 text-black">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-neutral-200 bg-white px-8 md:px-12 shadow-sm shadow-black/1">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              title="Notifications"
              className="relative h-10 w-10 flex items-center justify-center rounded-sm bg-neutral-50 border border-neutral-200 hover:bg-neutral-100 transition-all"
            >
            ...
            <div className="flex items-center gap-3 px-4 py-2 rounded-sm bg-black text-white outline-none font-bold">
              <div className="flex flex-col text-right">
                <span className="text-[10px] font-bold uppercase tracking-widest text-style-font text-style-font-static">
                  Administrateur
                </span>
                <span className="text-[8px] font-bold text-neutral-400 uppercase tracking-[0.2em] text-style-font text-style-font-static">
                  Console de contrôle
                </span>
              </div>
