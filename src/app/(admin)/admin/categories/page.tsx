    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {categories.map((category) => (
          <div key={category.id} className="bg-surface rounded-sm p-8 border border-border shadow-sm hover:border-accent hover:shadow-xl hover:shadow-accent/5 transition-all group relative overflow-hidden">
             {/* Icon Background */}
             <div className="absolute -bottom-6 -right-6 h-32 w-32 bg-accent/5 rounded-sm blur-sm group-hover:bg-accent/10 transition-colors"></div>
             
             <div className="flex items-start justify-between mb-8 relative z-10">
                <div className="h-14 w-14 rounded-sm bg-accent-light text-accent flex items-center justify-center">
             ...
             <div className="flex flex-col relative z-10">
                <h3 className="text-xl font-bold text-text-primary tracking-tight mb-2 group-hover:text-accent transition-colors">{category.nom}</h3>
