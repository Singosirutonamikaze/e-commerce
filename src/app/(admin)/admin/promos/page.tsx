          ...
          <table className="w-full text-left table-fixed min-w-[900px]">
            <thead>
              <tr className="bg-surface-alt/30 border-b border-border">
                <th className="px-8 py-5 text-[10px] font-black uppercase text-text-hint tracking-widest w-1/4">Code</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase text-text-hint tracking-widest w-1/4">Réduction</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase text-text-hint tracking-widest w-1/4 text-center">Validité</th>
                <th className="px-8 py-5 text-[10px] font-black uppercase text-text-hint tracking-widest w-1/6 text-center">Utilisations</th>
                ...
                <tr key={promo.id} className="border-b border-border last:border-0 hover:bg-surface-alt/10 transition-all group">
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-3">
                       <div className="h-10 w-10 rounded-xl bg-accent-light text-accent flex items-center justify-center font-black">
                         <Ticket className="h-5 w-5" />
                       </div>
                       <div className="flex flex-col">
                          <span className="text-sm font-black text-text-primary tracking-widest uppercase">{promo.code}</span>
                  ...
                  <td className="px-8 py-6 text-center">
                    <div className="flex flex-col items-center">
                       <span className="text-sm font-black text-text-primary">{promo.nombreUtilisations}</span>
