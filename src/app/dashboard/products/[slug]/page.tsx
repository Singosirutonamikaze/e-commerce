...
export default async function ProductDetailPage({
  ...
  return (
    <main className="pt-8 pb-24 px-6 md:px-12 min-h-screen bg-white">
      <div className="max-w-7xl mx-auto">
        <Link
          href="/dashboard/catalogue"
          className="inline-flex items-center gap-2 mb-8 text-sm font-bold text-neutral-600 hover:text-black transition-colors"
        >
            ...
            <div className="bg-neutral-50 p-8 rounded-sm border border-neutral-100 flex flex-col gap-6 mb-16 shadow-sm">
              <div className="flex flex-col sm:flex-row gap-3">
                <AddToCartButton
                  product={product}
                  requireAuth={false}
                  className="grow h-12 rounded-sm font-bold uppercase tracking-widest text-[11px] bg-black text-white hover:bg-neutral-800"
                />
                <button
                  title="Ajouter à la liste de souhaits"
                  aria-label="Ajouter à la liste de souhaits"
                  className="h-12 w-12 flex items-center justify-center rounded-sm border border-neutral-200 bg-white hover:border-black transition-all group"
                >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[10px] text-neutral-500 font-medium leading-relaxed">
                    Expédition sécurisée sous 24/48h.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[10px] text-neutral-500 font-medium leading-relaxed">
                    Procédure simplifiée sous 30 jours.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[10px] text-neutral-500 font-medium leading-relaxed">
                    Contrôle qualité certifié Système.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-[10px] text-neutral-500 font-medium leading-relaxed">
                    Disponible en point de retrait agréé.
                  </p>
                </div>
              </div>
            </div>
