      ...
      {categories.map((cat) => (
        <div key={cat.id} className="group flex flex-col gap-6">
          <Link
            ...
            className="group block relative overflow-hidden rounded-sm bg-neutral-50 border border-neutral-100 transition-all duration-500 hover:shadow-xl hover:shadow-black/5"
          >
