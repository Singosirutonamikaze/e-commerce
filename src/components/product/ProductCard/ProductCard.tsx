  ...
  return (
    <div className="group relative flex flex-col bg-white rounded-sm transition-all duration-300">
      ...
      <Link
        ...
        className="relative aspect-4/5 overflow-hidden rounded-sm bg-neutral-50 border border-neutral-100"
      >
        <Image
          src={mainImage}
          alt={product.nom}
      ...
      <div className="pt-6 pb-2 flex flex-col">
        ...
        <Link
          href={ROUTES.DASHBOARD.PRODUCT_DETAIL(product.slug)}
          className="flex items-center justify-between group/link mb-2"
        >
